...
/* #undef KTB_PRIVATE_BUILD */
#include <ktb/config.h>
 ...
 */
KTB_DLL ktb_errno ktb_sign_init(ktb_sign_ctx_t *ctx, ktb_hash_algo_t algo);
 ...
 * used again.
 */
KTB_DLL void ktb_sign_clear(ktb_sign_ctx_t ctx);
 ...
 */
KTB_DLL ktb_errno ktb_sign_reset(ktb_sign_ctx_t ctx);
 ...
 * ktb_sign_set_public_key() or ktb_sign_set_private_key()).
 */
KTB_DLL ktb_errno ktb_sign_process(ktb_sign_ctx_t ctx, const void *data,
        size_t data_size);
 ...
 * undefined.
 */
KTB_DLL ktb_errno ktb_sign_finalise(ktb_sign_ctx_t ctx);
 ...
 */
KTB_DLL ktb_errno ktb_sign_set_public_key(ktb_sign_ctx_t ctx,
 ...
 */
KTB_DLL ktb_errno ktb_sign_verify(ktb_sign_ctx_t ctx, const void *signature,
 ...
 */
KTB_DLL ktb_errno ktb_sign_verify_block(ktb_hash_algo_t algo,
 ...
 * the signature context use it.
 */
KTB_DLL ktb_errno ktb_sign_set_private_key(ktb_sign_ctx_t ctx,
 ...
 */
KTB_DLL size_t ktb_sign_get_sign_size(ktb_sign_ctx_t ctx);
 ...
 */
KTB_DLL const void *ktb_sign_get_sign(ktb_sign_ctx_t ctx, size_t *size);
 ...
 */
KTB_DLL size_t ktb_sign_get_sign_size_from_key(const_ktb_private_key_t private_key);
 ...
 */
KTB_DLL ktb_errno ktb_sign_sign_block(ktb_hash_algo_t algo, ktb_prng_t prng,
